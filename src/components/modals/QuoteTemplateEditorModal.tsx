...
export default function QuoteTemplateEditorModal({
  ...
  return (
    <TipTapTemplateEditorLayout
      editor={editor}
      pageTitle={isNew ? 'Yeni teklif şablonu' : 'Teklif şablonu düzenle'}
      templateName={templateName}
      onTemplateNameChange={setTemplateName}
      namePlaceholder="Örn: Standart Teklif Şablonu"
      isBusy={isBusy}
      ...
      documentNumberKey="teklifNo"
      documentNumberLabel="Teklif No"
      showMaterialTable
