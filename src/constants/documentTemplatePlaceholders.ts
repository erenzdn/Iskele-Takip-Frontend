...
export const DOCUMENT_TEMPLATE_PLACEHOLDERS = {
  ...
  teklif: [
    ...
    { key: 'kiralananSure', label: 'Kiralanan Süre' },
    { key: 'urunBirimFiyati', label: 'Ürün Birim Fiyatı' },
    { key: 'toplamUrunBirimFiyati', label: 'Toplam Ürün Birim Fiyatı' },
    { key: 'teklifNotu', label: 'Teklif Notu' },
    { key: 'toplamKdvliSatisFiyati', label: 'Toplam KDV\'li Satış Fiyatı' },
